...
Tttalk.prototype = {
  ...
  // 翻译后的回调
  // params: {"loginid":"3638","user_id":"3638","app_name":"","message_id":"5286107","from_lang":"CN","from_content":"http://wechat.tttalk.org/test.html","from_content_length":"6","to_lang":"EN","fee":"65.0","auto_translate":"0","translator_id":null,"callback_id":"247","to_content":""}
      ...
      charge_dao.createCharge(
        ...
        function(err, results, charge){
          ...
          wxservice.sendtemplate(openid, 'gpSAiTeGUNsjr3Ks0P_DBiLPpcWgu0K9QLozrL_kVqo', 'http://wechat.tttalk.org', {
            ...
            "amount": {
              "value":i18n.__('pay_template_unit', parseFloat(total_fee) / 100),
              "color":"#383232"
            },
            "result": {
