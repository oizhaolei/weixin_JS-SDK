...
Tttalk.prototype = {
  ...
  requestTranslatePhoto : function(from_lang, to_lang, filename, username, callback) {
    this._requestTranslate(from_lang, to_lang, 'photo', filename, username, callback);
  },
  ...
  requestTranslateVoice : function(from_lang, to_lang, filename, username, callback) {
    ...
    oss.putObject(sourceFile, dest, '', 0, function(err, data) {
      me._requestTranslate(from_lang, to_lang, 'voice', filename, username, function(err, newId){
        callback(err, newId);
