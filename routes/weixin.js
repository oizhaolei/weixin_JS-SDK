...
router.post('/translate_callback', function(req, res, next) {
  var params = req.body;
  logger.debug(params);
  tttalk.translate_callback(params.auto_translate, params.from_content, params.from_lang, params.to_content, params.to_lang, params.callback_id, function(message) {
    // 客服API消息回复
